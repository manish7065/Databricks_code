...
df.select('id', explode_outer('phone_numbers')).show()

# COMMAND ----------

df.select('*', explode('phone_numbers')).withColumnRenamed('key', 'number_type').withColumnRenamed('vlaue','phone_number').drop('phone_numbers').show()
