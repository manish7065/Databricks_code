...
employeesDF.withColumn('bonus', lit(0)).show()

# COMMAND ----------

employeesDF.withColumn('bonus', col('bonus').cast('int')).show()

# COMMAND ----------

employeesDF.withColumn('bonus1', col('bonus').cast('int'),lit(0)).show()
